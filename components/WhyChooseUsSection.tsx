  ...
  return (
    <section id="why-us" className="py-24 bg-gradient-to-br from-secondary to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom CTA */}
        <div className="mt-20 bg-white/10 backdrop-blur-sm rounded-xl p-12 text-center border border-white/20">
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 bg-primary text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-opacity-90 transition-all"
          >
            Get Your Free Quote
          </a>
        </div>
