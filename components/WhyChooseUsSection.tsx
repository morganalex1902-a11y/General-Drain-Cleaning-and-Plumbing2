    ...
    <section id="why-us" className="py-24 bg-gradient-to-br from-secondary to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto animate-fadeInUp [animation-delay:0.1s] opacity-0 [animation-fill-mode:both]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {reasons.map((reason, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white/10 backdrop-blur-sm rounded-xl p-8 hover:bg-white/20 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 animate-fadeInUp opacity-0 [animation-fill-mode:both]"
        ...
        {/* Bottom CTA */}
        <div className="mt-20 bg-white/10 backdrop-blur-sm rounded-xl p-12 text-center border border-white/20 hover:bg-white/20 transition-all duration-300 animate-fadeInUp [animation-delay:0.6s] opacity-0 [animation-fill-mode:both]">
